...
public class BinTree extends InWindow {
  ...
  public boolean Create(final int historySize, final int keepAddBufferBefore,
      final int matchMaxLen, final int keepAddBufferAfter) {
    ...
    super.Create(historySize + keepAddBufferBefore, matchMaxLen + keepAddBufferAfter,
        windowReservSize);
  ...
  public int GetMatches(final int[] distances) throws IOException {
    ...
    while (true) {
      ...
      final int cyclicPos = ((delta <= _cyclicBufferPos) ? (_cyclicBufferPos - delta)
