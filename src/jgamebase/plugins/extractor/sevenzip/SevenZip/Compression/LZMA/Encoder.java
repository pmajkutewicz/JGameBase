package jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.LZMA;

import java.io.IOException;

import jgamebase.plugins.extractor.sevenzip.SevenZip.ICodeProgress;
import jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.BitTreeEncoder;
...
public class Encoder {
  ...
  class LiteralEncoder {
    class Encoder2 {
      ...
      public void Init() {
        jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder
            .InitBitModels(m_Encoders);
      }

      public void Encode(
          final jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder rangeEncoder,
          final byte symbol) throws IOException {
        int context = 1;
        for (int i = 7; i >= 0; i--) {
      ...
      public void EncodeMatched(
          final jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder rangeEncoder,
          final byte matchByte, final byte symbol) throws IOException {
        int context = 1;
        boolean same = true;
        for (int i = 7; i >= 0; i--) {
          final int bit = ((symbol >> i) & 1);
      ...
      public int GetPrice(final boolean matchMode, final byte matchByte, final byte symbol) {
        ...
        if (matchMode) {
          for (; i >= 0; i--) {
            final int matchBit = (matchByte >> i) & 1;
            final int bit = (symbol >> i) & 1;
            price += jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder
  ...
  class LenEncoder {
    ...
    public void Encode(
        final jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder rangeEncoder,
        int symbol, final int posState) throws IOException {
    ...
    public void SetPrices(final int posState, final int numSymbols, final int[] prices, final int st) {
      final int a0 = jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder
          .GetPrice0(_choice[0]);
      final int a1 = jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder
          .GetPrice1(_choice[0]);
      final int b0 = a1
          + jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder
              .GetPrice0(_choice[1]);
  ...
  class LenPriceTableEncoder extends LenEncoder {
    ...
    public void Encode(
        final jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder rangeEncoder,
        final int symbol, final int posState) throws IOException {
  ...
  jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder _rangeEncoder = new jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder();
  ...
  void Create() {
    if (_matchFinder == null) {
      final jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.LZ.BinTree bt = new jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.LZ.BinTree();
      int numHashBytes = 4;
  ...
  void MovePos(final int num) throws java.io.IOException {
    if (num > 0) {
  ...
  int GetRepLen1Price(final int state, final int posState) {
    return jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder
  ...
  int GetOptimum(int position) throws IOException {
    ...
    _optimum[1].Price = jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder
        .GetPrice0(_isMatch[(_state << Base.kNumPosStatesBitsMax) + posState])
        + _literalEncoder.GetSubCoder(position, _previousByte).GetPrice(
            !Base.StateIsCharState(_state), matchByte, currentByte);
    _optimum[1].MakeAsChar();

    int matchPrice = jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder
  ...
  public void CodeOneBlock(final long[] inSize, final long[] outSize, final boolean[] finished)
      throws IOException {
    inSize[0] = 0;
    outSize[0] = 0;
    finished[0] = true;
    ...
    while (true) {
      ...
      if ((len == 1) && (pos == -1)) {
        ...
        final byte curByte = _matchFinder.GetIndexByte((0 - _additionalOffset));
        final LiteralEncoder.Encoder2 subCoder = _literalEncoder.GetSubCoder((int) nowPos64,
            _previousByte);
  ...
  void SetOutStream(final java.io.OutputStream outStream) {
  ...
  void SetStreams(final java.io.InputStream inStream, final java.io.OutputStream outStream,
      final long inSize, final long outSize) {
    _inStream = inStream;
    _finished = false;
    Create();
  ...
  public void Code(final java.io.InputStream inStream, final java.io.OutputStream outStream,
      final long inSize, final long outSize, final ICodeProgress progress) throws IOException {
    _needReleaseMFStream = false;
    try {
  ...
  public void WriteCoderProperties(final java.io.OutputStream outStream) throws IOException {
  ...
  void FillDistancesPrices() {
    for (int i = Base.kStartPosModelIndex; i < Base.kNumFullDistances; i++) {
      ...
      final int footerBits = ((posSlot >> 1) - 1);
      final int baseVal = ((2 | (posSlot & 1)) << footerBits);
      tempPrices[i] = BitTreeEncoder.ReverseGetPrice(_posEncoders, baseVal - posSlot - 1,
    ...
    for (int lenToPosState = 0; lenToPosState < Base.kNumLenToPosStates; lenToPosState++) {
      ...
      for (posSlot = Base.kEndPosModelIndex; posSlot < _distTableSize; posSlot++) {
        _posSlotPrices[st + posSlot] += ((((posSlot >> 1) - 1) - Base.kNumAlignBits) << jgamebase.plugins.extractor.sevenzip.SevenZip.Compression.RangeCoder.Encoder.kNumBitPriceShiftBits);
      }
  ...
  public boolean SeNumFastBytes(final int numFastBytes) {
