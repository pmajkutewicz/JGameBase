...
public class Decoder
{
	...
	// public java.io.InputStream Stream;
        ...
        public jgamebase.plugins.extractor.sevenzip.SevenZip.Common.InBuffer bufferedStream = new jgamebase.plugins.extractor.sevenzip.SevenZip.Common.InBuffer();
        
        int read() throws IOException {
            return bufferedStream.read();
        }
        
        public void Create(final int bufferSize) { bufferedStream.Create(bufferSize); }
        
        public long GetProcessedSize() {
            return bufferedStream.GetProcessedSize();
        }
	
	public final void SetStream(final java.io.InputStream stream)
	{ 
