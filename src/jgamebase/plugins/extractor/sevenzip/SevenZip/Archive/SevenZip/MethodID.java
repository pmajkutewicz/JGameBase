...
class MethodID {
  ...
  public MethodID(final int a, final int b, final int c) {
    final int size = 3;
    ID = new byte[size];
    IDSize = (byte) size;
    ID[0] = (byte) a;
  ...
  public MethodID(final int a, final int b, final int c, final int d) {
    final int size = 4;
    ID = new byte[size];
    IDSize = (byte) size;
    ID[0] = (byte) a;
  ...
  public boolean equals(final MethodID anObject) {
