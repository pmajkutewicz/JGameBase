...
public class LzmaAlone {
  static public class CommandLine {
    ...
    boolean ParseSwitch(final String s) {
      if (s.startsWith("d")) {
    ...
    public boolean Parse(final String[] args) throws Exception {
      int pos = 0;
  ...
  public static void main(final String[] args) throws Exception {
    ...
    if (params.Command == CommandLine.kBenchmak) {
      ...
      jgamebase.plugins.extractor.sevenzip.SevenZip.LzmaBench.LzmaBenchmark(
          params.NumBenchmarkPasses, dictionary);
