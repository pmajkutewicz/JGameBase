REBOL [
    ...
    Purpose: {
        A useful doc formatting language.   Converts text to
        HTML with titles, sections, sub-sections, and code.
        Is used to create all REBOL How-to documents.
    }
    Usage: {
